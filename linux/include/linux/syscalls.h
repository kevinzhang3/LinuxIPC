...
int __sys_setsockopt(int fd, int level, int optname, char __user *optval,
		int optlen);
/*        CMPT 432/832 CHANGE BY zbk618 job345, 2025, Jan, 26*/
asmlinkage long sys_pSend(pid_t to, void *sData, unsigned int slen, void *rData, 
        unsigned int *rlen);
asmlinkage long sys_pReceive(pid_t *pid, void *Data, unsigned int *len);
asmlinkage long sys_pReply(pid_t sndr, void *Data, unsigned int len);
asmlinkage long sys_pMsgWaits(void);
/*        end CMPT 432/832 CHANGE BY zbk618 job345, 2025, Jan, 26*/
